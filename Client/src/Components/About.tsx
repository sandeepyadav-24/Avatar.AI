const About = () => {
  return (
    <div className="bg-black py-3 md:py-14 md:h-screen ">
      <h1 className="font-extrabold text-4xl mx-10 my-5 text-white">
        About Us & Project Inspiration
      </h1>
      <div className="px-10 py-5 my-3 mx-5 md:mx-14 md:p-6 rounded-2xl md:flex md:flex-row bg-[#18181B]">
        <div className="Content md:mx-24 text-[#C8C8C8]">
          ...
          <h1>
            LinkedIn:{" "}
            <a href="https://linkedin.com/in/sandeep-yadav-027500219">
              linkedin.com/in/sandeep-yadav-027500219
            </a>
          </h1>
          <h1>
            Email: <a href="">sandeepyadav004343@gmail.com</a>
            Email: <a href="">iamakshitheregmail.com</a>
          </h1>
        </div>
      </div>
    </div>
